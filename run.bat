...
title TIMDR Battery Predict - Dashboard

echo ============================================================
echo  TIMDR Battery Predict - uruchamianie dashboardu
echo ============================================================
echo.
...
echo Uzywam: %PYCMD%
echo.
echo Instaluje/aktualizuje zaleznosci (flask, numpy)...
%PYCMD% -m pip install --quiet --upgrade pip
%PYCMD% -m pip install --quiet flask numpy
if %ERRORLEVEL% NEQ 0 (
